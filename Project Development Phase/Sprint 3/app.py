...
import os
from tensorflow.keras.models import load_model#to load our trained model import os
...
def launch():
    if request.method == 'POST':
        ...
        while True: 
            frame = cap.read() #capturing the video frame values # Simulating mirror image 
            frame = cv2.flip(frame, 1)
            
            #Got this from collect-data.py # Coordinates of the ROI
